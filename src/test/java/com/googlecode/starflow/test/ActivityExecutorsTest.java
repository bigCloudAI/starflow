 ...
 *
 */
public class ActivityExecutorsTest extends AbstractFlowTest {
	
	@Test
	public void testFlow() {
		//部署流程
		procDefService.deployProcessFile("classpath:flow/ActivityExecutors.xml");
		...
		for(int i=0; i<1; i++) {
			...
			//启动流程
			ProcessInstance processInstance = procInstService.createProcess("activityExecutors", "100001");
			//创建流程
