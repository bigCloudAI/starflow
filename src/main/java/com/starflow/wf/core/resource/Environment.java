...
package com.starflow.wf.core.resource;
...
public final class Environment {
	public static final String PARIMARY_KEY_CACHE_NUM = "com.starflow.core.key.cache.num";
	
	public static final String IS_USE_WEBSERVICE = "com.starflow.wf.use.webservice";
	
	public static final String IS_USE_TRANSACTION = "com.starflow.wf.use.transaction";
