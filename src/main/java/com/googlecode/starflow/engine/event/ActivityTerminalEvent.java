...
public class ActivityTerminalEvent extends AbstractFlowEvent {
	private ActivityInst activityInst;
	
	public ActivityTerminalEvent(ProcessEngine processEngine) {
		this(processEngine.getApplicationContext());
		this.setProcessEngine(processEngine);
	}

	private ActivityTerminalEvent(ApplicationContext source) {
		super(source);
	}
